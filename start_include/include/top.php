<!-- 절대경로 : 추후 삭제 필요-->
<? $root = "http://ryutask.dothome.co.kr/task/start_include"; ?>
<? $d_root = $_SERVER['DOCUMENT_ROOT'].'/task/start_include'; ?>
<!-- 절대경로 : 추후 삭제 필요-->
...
<head>
	...
	<script src="https://use.fontawesome.com/ef2f156501.js"></script>
	<!--[if lt IE 9]>
